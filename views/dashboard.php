...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit-user.php?user_id=<?= $user_detail['id'] ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pencil"></i></a>
                        <?php
    ...
    <script src="https://kit.fontawesome.com/e361517e58.js" crossorigin="anonymous"></script>
</body>
</html>